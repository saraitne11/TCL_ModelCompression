...
def main():
    ...
    parser.add_argument('--image-size', type=int, default=128,
                        help="Image Size")
    parser.add_argument('--image-max-count', type=int, default=1000,
                        help="Train Image Max Count")

    ################## size 받는거 arg/ max_images cnt 받기
    ...
    for images, labels in loader:
        if max_cnt<args.image_max_count:
            ...
            images_byte = BytesIO(pickle.dumps(images_resize))
